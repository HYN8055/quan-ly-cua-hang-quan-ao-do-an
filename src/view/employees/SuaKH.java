...
public class SuaKH extends javax.swing.JDialog {
     ...
     */
    public SuaKH(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Nhập tên khách hàng...");
        ...
        jTextField4.setText("Nhập email...");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SuaKH dialog = new SuaKH(new javax.swing.JFrame(), true);
