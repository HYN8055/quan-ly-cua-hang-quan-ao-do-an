...
public class XemCTHD extends javax.swing.JDialog {
     ...
     */
    public XemCTHD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("XEM CHI TIẾT THÔNG TIN HÓA ĐƠN");
        ...
        jScrollPane22.setViewportView(jTable_CTHD);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XemCTHD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                XemCTHD dialog = new XemCTHD(new javax.swing.JFrame(), true);
