 ...
 * @author hyn09
 */
public class ThemPX extends javax.swing.JDialog {

    /**
     * Creates new form ThemPX
     */
    public ThemPX(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("THÊM PHIẾU XUẤT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemPX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThemPX dialog = new ThemPX(new javax.swing.JFrame(), true);
