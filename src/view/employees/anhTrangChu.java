 ...
 * @author hyn09
 */
public class anhTrangChu extends javax.swing.JPanel {

    /**
     * Creates new form anhTrangChu
     */
    public anhTrangChu() {
        initComponents();
        setOpaque(false);
    ...
    protected void paintChildren(Graphics grphcs){
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#c4e0e5"), getHeight(), 0, Color.decode("#4ca1af"));
        g2.setPaint(g);
